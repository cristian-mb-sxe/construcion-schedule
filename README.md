...
## License
<div id="license"></div>
Distributed under the MIT License. See <img src="https://github.com/cristian-mb-sxe/construction_schedule/-/blob/main/LICENSE">`LICENSE`</img> for more information.
